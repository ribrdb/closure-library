 ...
 * @type {string}
 */
export var OPENHAND_FILE = 'openhand.cur';
 ...
 * @type {string}
 */
export var CLOSEDHAND_FILE = 'closedhand.cur';
 ...
 */
export function getDraggableCursorStyle(absoluteDotCurFilePath, opt_obsolete) {
 return getCursorStyle_(
     '-moz-grab', absoluteDotCurFilePath + OPENHAND_FILE,
     'default');
}
 ...
 */
export function getDraggingCursorStyle(absoluteDotCurFilePath, opt_obsolete) {
 return getCursorStyle_(
     '-moz-grabbing',
     absoluteDotCurFilePath + CLOSEDHAND_FILE, 'move');
}
 ...
 * @private
 */
function getCursorStyle_(geckoNonWinBuiltInStyleValue, absoluteDotCurFilePath, defaultStyle) {
 ...
 if (userAgent.GECKO && !userAgent.WINDOWS) {
