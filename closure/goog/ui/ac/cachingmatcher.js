 ...
 * @final
 */
export function CachingMatcher(baseMatcher) {
  ...
  */
 this.getMatchesForRows_ = ArrayMatcher.getMatchesForRows;
 ...
 this.throttledTriggerBaseMatch_ =
     new Throttle(this.triggerBaseMatch_, 150, this);
 ...
 */
CachingMatcher.prototype.setThrottleTime = function(throttleTime) {
 this.throttledTriggerBaseMatch_ =
     new Throttle(this.triggerBaseMatch_, throttleTime, this);
};
 ...
 */
CachingMatcher.prototype.setBaseMatcherMaxMatches = function(
    maxMatches) {
 ...
 */
CachingMatcher.prototype.setMaxCacheSize = function(maxCacheSize) {
 ...
 *     localMatcher
 */
CachingMatcher.prototype.setLocalMatcher = function(localMatcher) {
 ...
 */
CachingMatcher.prototype.requestMatchingRows = function(
...
/** Clears the cache. */
CachingMatcher.prototype.clearCache = function() {
 this.rows_ = [];
 this.rowStrings_ = {};
};
 ...
 * @private
 */
CachingMatcher.prototype.addRows_ = function(rows) {
 ...
 * @private
 */
CachingMatcher.prototype.clearCacheIfTooLarge_ = function() {
 ...
 */
CachingMatcher.prototype.triggerBaseMatch_ = function() {
 ...
 * @private
 */
CachingMatcher.prototype.onBaseMatch_ = function(token, matches) {
