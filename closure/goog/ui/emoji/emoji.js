...
goog.declareModuleId('goog.ui.emoji.emoji');
 ...
 * @final
 */
export function Emoji(url, id, opt_height, opt_width, opt_altText) {
 /**
 ...
 * @type {string}
 * @deprecated Use Emoji.DATA_ATTRIBUTE instead.
 */
Emoji.ATTRIBUTE = 'goomoji';
 ...
 * @type {string}
 */
Emoji.DATA_ATTRIBUTE = 'data-' + Emoji.ATTRIBUTE;
 ...
 */
Emoji.prototype.getId = function() {
 return this.id_;
};
 ...
 */
Emoji.prototype.getHeight = function() {
 return this.height_;
};
 ...
 */
Emoji.prototype.getWidth = function() {
 return this.width_;
};
 ...
 */
Emoji.prototype.getAltText = function() {
