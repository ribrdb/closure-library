...
goog.declareModuleId('goog.ui.container');
 ...
 *  </ul>
 * @param {?Container.Orientation=} opt_orientation Container
 ...
 * @param {dom.DomHelper=} opt_domHelper DOM helper, used for document
 *     interaction.
 * @extends {Component}
 * @constructor
 */
export function Container(opt_orientation, opt_renderer, opt_domHelper) {
  Component.call(this, opt_domHelper);
  this.renderer_ = opt_renderer || ContainerRenderer.getInstance();
  this.orientation_ = opt_orientation || this.renderer_.getDefaultOrientation();
}
goog.inherits(Container, Component);
 ...
 * @private
 */
Container.prototype.keyEventTarget_ = null;
 ...
 * @private
 */
Container.prototype.keyHandler_ = null;
 ...
 * @private
 */
Container.prototype.renderer_ = null;
 ...
 * @private
 */
Container.prototype.orientation_ = null;
 ...
 * @private
 */
Container.prototype.visible_ = true;
 ...
 * @private
 */
Container.prototype.enabled_ = true;
 ...
 * @private
 */
Container.prototype.focusable_ = true;
 ...
 * @private
 */
Container.prototype.highlightedIndex_ = -1;
 ...
 * @private
 */
Container.prototype.openItem_ = null;
 ...
 * @private
 */
Container.prototype.mouseButtonPressed_ = false;
 ...
 * @private
 */
Container.prototype.allowFocusableChildren_ = false;
 ...
 * @private
 */
Container.prototype.openFollowsHighlight_ = true;
 ...
 * @private
 */
Container.prototype.childElementIdMap_ = null;
 ...
 *     events.
 */
Container.prototype.getKeyEventTarget = function() {
 ...
 */
Container.prototype.setKeyEventTarget = function(element) {
  if (this.focusable_) {
 ...
 */
Container.prototype.getKeyHandler = function() {
 ...
 * an existing element.
 * @return {ContainerRenderer} Renderer used by the container.
 */
Container.prototype.getRenderer = function() {
 ...
 * @param {ContainerRenderer} renderer Renderer used by the container.
 */
Container.prototype.setRenderer = function(renderer) {
  if (this.getElement()) {
    // Too late.
 ...
 * @override
 */
Container.prototype.getContentElement = function() {
  // Delegate to renderer.
 ...
 * @override
 */
Container.prototype.canDecorate = function(element) {
  // Delegate to renderer.
 ...
 * @override
 */
Container.prototype.decorateInternal = function(element) {
  // Delegate to renderer.
 ...
 */
Container.prototype.enterDocument = function() {
  Container.superClass_.enterDocument.call(this);
  ...
  this.getHandler()
      ...
      .listen(
          ...
          [
            ...
            MouseEventType.MOUSECANCEL, EventType.MOUSEOVER,
  ...
  if (this.pointerEventsEnabled()) {
    ...
    this.getHandler().listen(
        elem, EventType.GOTPOINTERCAPTURE,
 ...
 * @private
 */
Container.prototype.enableFocusHandling_ = function(enable) {
  var handler = this.getHandler();
  var keyTarget = this.getKeyEventTarget();
  if (enable) {
    handler.listen(keyTarget, EventType.FOCUS, this.handleFocus)
        .listen(keyTarget, EventType.BLUR, this.handleBlur)
        .listen(
            this.getKeyHandler(), KeyHandler.EventType.KEY,
            this.handleKeyEvent);
  } else {
    handler.unlisten(keyTarget, EventType.FOCUS, this.handleFocus)
        .unlisten(keyTarget, EventType.BLUR, this.handleBlur)
        .unlisten(
            this.getKeyHandler(), KeyHandler.EventType.KEY,
            this.handleKeyEvent);
  }
 ...
 * @override
 */
Container.prototype.exitDocument = function() {
  ...
  Container.superClass_.exitDocument.call(this);
};


/** @override */
Container.prototype.disposeInternal = function() {
  Container.superClass_.disposeInternal.call(this);
 ...
 *    the event.
 */
Container.prototype.handleEnterItem = function(e) {
...
Container.prototype.handleHighlightItem = function(e) {
  ...
  if (index > -1 && index != this.highlightedIndex_) {
    ...
    if (this.openFollowsHighlight_ && this.openItem_ &&
        item != this.openItem_) {
      if (item.isSupportedState(Component.State.OPENED)) {
        item.setOpen(true);
      } else {
        this.openItem_.setOpen(false);
      }
...
Container.prototype.handleUnHighlightItem = function(e) {
  ...
  aria.removeState(element, State.ACTIVEDESCENDANT);
};
...
Container.prototype.handleCloseItem = function(e) {
  ...
  if (element && e.target.isHighlighted() && targetEl) {
    aria.setActiveDescendant(element, targetEl);
  }
};
...
Container.prototype.handleMouseDown = function(e) {
  ...
  var keyTarget = this.getKeyEventTarget();
  if (keyTarget && dom.isFocusableTabIndex(keyTarget)) {
 ...
 * @suppress {strictMissingProperties} Part of the go/strict_warnings_migration
 */
Container.prototype.getOwnerControl = function(node) {
 ...
 *     its children).
 */
Container.prototype.handleKeyEventInternal = function(e) {
  ...
  switch (e.keyCode) {
    ...
    case KeyCodes.UP:
      if (this.orientation_ == Container.Orientation.VERTICAL) {
    ...
    case KeyCodes.LEFT:
      if (this.orientation_ == Container.Orientation.HORIZONTAL) {
 ...
 * @param {Component} child The child control. Its root element has
 *     to be created yet.
 * @private
 */
Container.prototype.registerChildId_ = function(child) {
 ...
 * @param {Component} control New child.
 * @param {number} index Index at which the new child is to be added.
 * @param {boolean=} opt_render Whether the new child should be rendered
 *     immediately after being added (defaults to false).
 * @override
 */
Container.prototype.addChildAt = function(control, index, opt_render) {
  ...
  control.setDispatchTransitionEvents(Component.State.HOVER, true);
  control.setDispatchTransitionEvents(Component.State.OPENED, true);
  ...
  Container.superClass_.addChildAt.call(
 ...
 * @private
 */
Container.prototype.updateHighlightedIndex_ = function(
    fromIndex, toIndex) {
  if (fromIndex == -1) {
 ...
 * @param {string|Component} control The ID of the child to remove, or
 *     the control itself.
 ...
 * @override
 */
Container.prototype.removeChild = function(control, opt_unrender) {
  ...
  control = /** @type {!Control} */ (
      Container.superClass_.removeChild.call(
 ...
 * @return {?Container.Orientation} Container orientation.
 */
Container.prototype.getOrientation = function() {
 ...
 * @param {Container.Orientation} orientation Container orientation.
 */
 ...
 */
Container.prototype.setVisible = function(visible, opt_force) {
  if (opt_force ||
    ...
    if (elem) {
      ...
      if (!opt_force) {
        this.dispatchEvent(
            this.visible_ ? Container.EventType.AFTER_SHOW :
 ...
 */
Container.prototype.setFocusable = function(focusable) {
 ...
 */
Container.prototype.isFocusableChildrenAllowed = function() {
 ...
 */
Container.prototype.setFocusableChildrenAllowed = function(focusable) {
 ...
 */
Container.prototype.isOpenFollowsHighlight = function() {
 ...
 */
Container.prototype.setOpenFollowsHighlight = function(follow) {
 ...
 */
Container.prototype.getHighlightedIndex = function() {
 ...
 *     highlight).
 */
Container.prototype.setHighlightedIndex = function(index) {
 ...
 */
Container.prototype.setHighlighted = function(item) {
 ...
 */
Container.prototype.getHighlighted = function() {
 ...
 */
Container.prototype.highlightFirst = function() {
 ...
 */
Container.prototype.highlightLast = function() {
  this.highlightHelper(function(index, max) {
    index--;
 ...
 * highlighted).
 */
Container.prototype.highlightNext = function() {
  this.highlightHelper(function(index, max) {
    return (index + 1) % max;
  }, this.highlightedIndex_);
};
 ...
 */
Container.prototype.highlightPrevious = function() {
  this.highlightHelper(function(index, max) {
    index--;
    return index < 0 ? max - 1 : index;
  }, this.highlightedIndex_);
 ...
 * @protected
 */
Container.prototype.highlightHelper = function(fn, startIndex) {
 ...
 * @protected
 */
Container.prototype.canHighlightItem = function(item) {
  return item.isVisible() && item.isEnabled() &&
      item.isSupportedState(Component.State.HOVER);
};
 ...
 * @protected
 */
Container.prototype.setHighlightedIndexFromKeyEvent = function(index) {
 ...
 */
Container.prototype.getOpenItem = function() {
 ...
 */
Container.prototype.isMouseButtonPressed = function() {
 ...
 */
Container.prototype.setMouseButtonPressed = function(pressed) {
