 ...
 *    styles.
 */
export function hexToRgbStyle(hexColor) {
 ...
 * @return {!Hsl} hsl representation of the color.
 */
export function rgbArrayToHsl(rgb) {
 ...
 * @return {!Rgb} rgb representation of the color.
 */
export function hslArrayToRgb(hsl) {
 ...
 */
export function prependZeroIfNecessaryHelper(hex) {
 ...
 *     already have one.
 */
export function prependHashIfNecessaryHelper(str) {
 ...
 * @return {!Hsv} hsv representation of the color.
 */
export function rgbArrayToHsv(rgb) {
 ...
 * @return {!Rgb} rgb representation of the color.
 */
export function hsvArrayToRgb(hsv) {
 ...
 * @return {string} hex representation of the color.
 */
export function hslArrayToHex(hsl) {
 ...
 * @return {string} hex representation of the color.
 */
export function hsvArrayToHex(hsv) {
 ...
 */
export function hslDistance(hsl1, hsl2) {
  let sl1;
  let sl2;
 ...
 */
export function blend(rgb1, rgb2, factor) {
 ...
 */
export function highContrast(prime, suggestions) {
