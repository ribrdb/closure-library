...
export function XhrManager(
 ...
 XhrManager.base(this, 'constructor');
 ...
 /**
     * The event handler.
     * @type {EventHandler<!XhrManager>}
     * @private
     */
 this.eventHandler_ = new EventHandler(this);
}
goog.inherits(XhrManager, EventTarget);
 ...
 * @private
 */
XhrManager.ERROR_ID_IN_USE_ = '[goog.net.XhrManager] ID in use';


/**
 * The EventType's to listen/unlisten for on the XhrIo object.
 * @type {Array<EventType>}
 * @private
 */
XhrManager.XHR_EVENT_TYPES_ = [
  EventType.READY,
  EventType.COMPLETE,
  EventType.SUCCESS,
  EventType.ERROR,
 ...
 */
XhrManager.prototype.setTimeoutInterval = function(ms) {
 ...
 */
XhrManager.prototype.getOutstandingCount = function() {
 ...
 */
XhrManager.prototype.getOutstandingRequestIds = function() {
 ...
 *     should be retried.
 * @param {XhrIo.ResponseType=} opt_responseType The response type of
 *     this request; defaults to XhrIo.ResponseType.DEFAULT.
 * @param {boolean=} opt_withCredentials Add credentials to this request,
 *     default: false.
 * @return {!XhrManager.Request} The queued request object.
 */
XhrManager.prototype.send = function(
 ...
 if (requests.get(id)) {
   throw new Error(XhrManager.ERROR_ID_IN_USE_);
 }

 // Make the Request object.
 const request = new XhrManager.Request(
 ...
 */
XhrManager.prototype.abort = function(id, opt_force) {
 ...
 if (request) {
   ...
   if (opt_force) {
     if (xhrIo) {
       ...
       events.listenOnce(xhrIo, EventType.READY, function() {
 ...
 * @param {!XhrIoPool} testingPool
 */
XhrManager.prototype.setXhrPoolForTesting = function(testingPool) {
 ...
 * @param {XhrIo} xhrIo The available XhrIo object.
 * @private
 */
XhrManager.prototype.handleAvailableXhr_ = function(id, xhrIo) {
 const request = this.requests_.get(id);
 ...
 if (request && !request.xhrIo) {
   ...
   this.dispatchEvent(
       new XhrManager.Event(
           EventType.READY, this, id, xhrIo));
 ...
 * @private
 */
XhrManager.prototype.handleEvent_ = function(id, e) {
 ...
 * @param {string} id The id of the request.
 * @param {XhrIo} xhrIo The XhrIo object.
 * @private
 */
XhrManager.prototype.retry_ = function(id, xhrIo) {
 const request = this.requests_.get(id);
 ...
 * @private
 */
XhrManager.prototype.handleComplete_ = function(id, xhrIo, e) {
 // Only if the request is done processing should a COMPLETE event be fired.
 const request = this.requests_.get(id);
 if (xhrIo.getLastErrorCode() == ErrorCode.ABORT ||
     xhrIo.isSuccess() || request.hasReachedMaxRetries()) {
   this.dispatchEvent(
       new XhrManager.Event(
           EventType.COMPLETE, this, id, xhrIo));
 ...
 * @private
 */
XhrManager.prototype.handleSuccess_ = function(id, xhrIo) {
 // Fire event.
 ...
 this.dispatchEvent(
     new XhrManager.Event(
         EventType.SUCCESS, this, id, xhrIo));
};
 ...
 * @private
 */
XhrManager.prototype.handleError_ = function(id, xhrIo) {
 const request = this.requests_.get(id);
 ...
 * @param {XhrIo} xhrIo The object to stop listenening to events on.
 ...
 * @private
 */
XhrManager.prototype.removeXhrListener_ = function(
    xhrIo, func, opt_types) {
 const types = opt_types || XhrManager.XHR_EVENT_TYPES_;
 ...
 * @param {XhrIo} xhrIo The object listen to events on.
 ...
 * @private
 */
XhrManager.prototype.addXhrListener_ = function(
    xhrIo, func, opt_types) {
 const types = opt_types || XhrManager.XHR_EVENT_TYPES_;
...
/** @override */
XhrManager.prototype.disposeInternal = function() {
 XhrManager.superClass_.disposeInternal.call(this);
 ...
 * @param {XhrManager} target Reference to the object that is the
 *     target of this event.
 * @param {string} id The id of the request this event is for.
 * @param {XhrIo} xhrIo The XhrIo object of the request.
 * @constructor
 * @extends {Event}
 * @final
 */
XhrManager.Event = function(type, target, id, xhrIo) {
...
goog.inherits(XhrManager.Event, Event);
...
XhrManager.Request = function(
 ...
 /**
   ...
   * @type {!XhrIo.ResponseType}
   * @private
   */
 this.responseType_ = opt_responseType || XhrIo.ResponseType.DEFAULT;
 ...
 */
XhrManager.Request.prototype.getUrl = function() {
 return this.url_;
};
 ...
 */
XhrManager.Request.prototype.getMethod = function() {
 return this.method_;
};
 ...
 *     The post data.
 */
XhrManager.Request.prototype.getContent = function() {
 ...
 * @return {Object|Map} The map of headers.
 */
XhrManager.Request.prototype.getHeaders = function() {
 ...
 */
XhrManager.Request.prototype.getWithCredentials = function() {
 ...
 */
XhrManager.Request.prototype.getMaxRetries = function() {
 ...
 */
XhrManager.Request.prototype.getAttemptCount = function() {
 ...
 */
XhrManager.Request.prototype.increaseAttemptCount = function() {
 this.attemptCount_++;
};
 ...
 *     retries.
 */
XhrManager.Request.prototype.hasReachedMaxRetries = function() {
 ...
 */
XhrManager.Request.prototype.setCompleted = function(complete) {
 ...
 */
XhrManager.Request.prototype.getCompleted = function() {
 ...
 */
XhrManager.Request.prototype.setAborted = function(aborted) {
 ...
 */
XhrManager.Request.prototype.getAborted = function() {
 ...
 *     XhrIo object.
 */
XhrManager.Request.prototype.getXhrEventCallback = function() {
 ...
 */
XhrManager.Request.prototype.getCompleteCallback = function() {
 ...
 * available.
 * @return {!XhrIo.ResponseType} The response type to be set
 *     when an XhrIo becomes available to this request.
 */
XhrManager.Request.prototype.getResponseType = function() {
