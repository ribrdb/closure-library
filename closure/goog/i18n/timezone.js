 ...
 *     time zone data.
 */
TimeZone.createTimeZone = function(timeZoneData) {
 ...
 * @private
 */
TimeZone.createSimpleTimeZone_ = function(timeZoneOffsetInMinutes) {
  var tz = new TimeZone();
 ...
 * @private
 */
TimeZone.composeGMTString_ = function(offset) {
  var parts = ['GMT'];
  parts.push(offset <= 0 ? '+' : '-');
 ...
 * @private
 */
TimeZone.composePosixTimeZoneID_ = function(offset) {
  if (offset == 0) {
    return 'Etc/GMT';
  }
 ...
 * @private
 */
TimeZone.composeUTCString_ = function(offset) {
  if (offset == 0) {
    return 'UTC';
  }
...
TimeZone.prototype.getTimeZoneData = function() {
  return {
    ...
    'names': array.clone(this.tzNames_),  // avoid aliasing the array
    'names_ext': object.clone(this.tzNamesExt_),   // avoid aliasing
    'transitions': array.clone(this.transitions_)  // avoid aliasing
  };
};
 ...
 */
TimeZone.prototype.getGMTString = function(date) {
 ...
 */
TimeZone.prototype.getUTCString = function(date) {
 ...
 */
TimeZone.prototype.getLongName = function(date) {
 ...
 */
TimeZone.prototype.getRFCTimeZoneString = function(date) {
 ...
 */
TimeZone.prototype.getShortName = function(date) {
  return this.tzNames_[this.isDaylightTime(date) ?
 ...
 */
TimeZone.prototype.getTimeZoneId = function() {
 ...
 */
TimeZone.prototype.getLongNameGMT = function(date) {
 ...
 */
TimeZone.prototype.getGenericLocation = function(date) {
  if (this.isDaylightTime(date)) {
