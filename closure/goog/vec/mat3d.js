 ...
 *
 * @param {!Type} mat The matrix to receive the values.
 * @param {!vec3d.Type} vec The vector containing the values.
 * @return {!Type} return mat so that operations can be
 *     chained together.
 */
 ...
 * @param {!Type} mat The matrix to receive the values.
 * @param {number} column The column index to set the values on.
 * @param {!vec3d.Type} vec The vector elements for the column.
 * @return {!Type} return mat so that operations can be
 *     chained together.
 */
 ...
 * @param {!vec3d.Type} vec The vector elements to receive the
 *     column.
 * @return {!vec3d.Type} return vec so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {!Type} mat The matrix to receive the values.
 * @param {!vec3d.Type} vec0 The values for column 0.
 * @param {!vec3d.Type} vec1 The values for column 1.
 * @param {!vec3d.Type} vec2 The values for column 2.
 * @return {!Type} return mat so that operations can be
 *     chained together.
 */
 ...
 * @param {!vec3d.Type} vec0 The vector to receive column 0.
 * @param {!vec3d.Type} vec1 The vector to receive column 1.
 * @param {!vec3d.Type} vec2 The vector to receive column 2.
 */
 ...
 * @param {!vec3d.Type} vec The vector to receive the row.
 * @return {!vec3d.Type} return vec so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {!Type} mat The matrix to receive the values.
 * @param {!vec3d.Type} vec0 The values for row 0.
 * @param {!vec3d.Type} vec1 The values for row 1.
 * @param {!vec3d.Type} vec2 The values for row 2.
 * @return {!Type} return mat so that operations can be
 *     chained together.
 */
 ...
 * @param {!vec3d.Type} vec0 The vector to receive row 0.
 * @param {!vec3d.Type} vec1 The vector to receive row 1.
 * @param {!vec3d.Type} vec2 The vector to receive row 2.
 */
 ...
 * @param {!vec3d.Type} vec The vector to transform.
 * @param {!vec3d.Type} resultVec The vector to
 ...
 *     of the default [0, pi].
 * @return {!vec3d.Type} return euler so that operations can be
 *     chained together.
 */
