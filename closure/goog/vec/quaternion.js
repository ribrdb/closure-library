 ...
 *
 * @return {!Float32} The new quaternion.
 */
export var createFloat32 = Vec4.createFloat32;


/**
 * Creates a Float64 quaternion, initialized to zero.
 *
 * @return {!Float64} The new quaternion.
 */
export var createFloat64 = Vec4.createFloat64;


/**
 * Creates a Number quaternion, initialized to zero.
 *
 * @return {Number} The new quaternion.
 */
export var createNumber = Vec4.createNumber;
 ...
 * supplied array.
 *
 * @param {!googVec.AnyType} vec The source 4 element array.
 * @return {!Float32} The new quaternion.
 */
export var createFloat32FromArray = Vec4.createFloat32FromArray;
 ...
 * @return {!Float64} The new quaternion.
 */
export var createFloat64FromArray = Vec4.createFloat64FromArray;
 ...
 * @return {!Float32} The new quaternion.
 */
export var createFloat32FromValues = Vec4.createFloat32FromValues;
 ...
 * @return {!Float64} The new quaternion.
 */
export var createFloat64FromValues = Vec4.createFloat64FromValues;


/**
 * Creates a clone of the given Float32 quaternion.
 *
 * @param {!Float32} q The source quaternion.
 * @return {!Float32} The new quaternion.
 */
export var cloneFloat32 = Vec4.cloneFloat32;


/**
 * Creates a clone of the given Float64 quaternion.
 *
 * @param {!Float64} q The source quaternion.
 * @return {!Float64} The new quaternion.
 */
export var cloneFloat64 = Vec4.cloneFloat64;
 ...
 * @return {!Float32} The new quaternion.
 */
export function createIdentityFloat32() {
 const quat = createFloat32();
 makeIdentity(quat);
 return quat;
}
 ...
 * @return {!Float64} The new quaternion.
 */
export function createIdentityFloat64() {
 const quat = createFloat64();
 makeIdentity(quat);
 return quat;
}
 ...
 *
 * @param {!AnyType} q The quaternion to receive
 *     the values.
 * @param {number} v0 The value for element at index 0.
 * @param {number} v1 The value for element at index 1.
 * @param {number} v2 The value for element at index 2.
 * @param {number} v3 The value for element at index 3.
 * @return {!Vec4.AnyType} return q so that operations can be
 *     chained together.
 */
export var setFromValues = Vec4.setFromValues;
 ...
 * @param {!AnyType} q The quaternion to receive
 *     the values.
 * @param {!googVec.AnyType} values The array of values.
 * @return {!AnyType} return q so that operations can be
 *     chained together.
 */
export var setFromArray = Vec4.setFromArray;


/**
 * Adds the two quaternions.
 *
 * @param {!AnyType} quat0 The first addend.
 * @param {!AnyType} quat1 The second addend.
 * @param {!AnyType} resultQuat The quaternion to
 ...
 *
 * @param {!AnyType} quat0 The quaternion to negate.
 * @param {!AnyType} resultQuat The quaternion to
 *     receive the result. May be quat0.
 */
export var negate = Vec4.negate;
 ...
 * resultVec.
 *
 * @param {!AnyType} quat0 The source quaternion.
 ...
 *
 * @param {!AnyType} quat0 The quaternion.
 * @return {number} The magnitude of the quaternion.
 */
export var magnitudeSquared = Vec4.magnitudeSquared;
 ...
 *
 * @param {!AnyType} quat0 The quaternion to
 *     normalize.
 * @param {!AnyType} resultQuat The quaternion to
 *     receive the result. May be quat0.
 */
 ...
 *
 * @param {!AnyType} q0 The first quaternion.
 * @param {!AnyType} q1 The second quaternion.
 ...
 *
 * @param {!AnyType} quat The quaternion to invert.
 * @param {!AnyType} resultQuat The quaternion to receive
 *     the result.
 * @return {!AnyType} Return resultQuat so that
 *     operations can be chained together.
 */
export function invert(quat, resultQuat) {
 const a0 = quat[0];
 const a1 = quat[1];
 const a2 = quat[2];
 const a3 = quat[3];
 ...
 *
 * @param {!AnyType} quat The source quaternion.
 * @param {!AnyType} resultQuat The quaternion to
 *     receive the result.
 * @return {!AnyType} Return resultQuat so that
 *     operations can be chained together.
 */
export function conjugate(quat, resultQuat) {
 resultQuat[0] = -quat[0];
 resultQuat[1] = -quat[1];
 resultQuat[2] = -quat[2];
 resultQuat[3] = quat[3];
 ...
 *
 * @param {!AnyType} quat0 The first quaternion.
 * @param {!AnyType} quat1 The second quaternion.
 * @param {!AnyType} resultQuat The quaternion to
 *     receive the result.
 * @return {!AnyType} Return resultQuat so that
 *     operations can be chained together.
 */
export function concat(quat0, quat1, resultQuat) {
 const w0 = quat0[3];
 const x0 = quat0[0];
 const y0 = quat0[1];
 const z0 = quat0[2];
 ...
 *
 * @param {!AnyType} quat The quaternion.
 * @return {!AnyType} Return quat so that
 *     operations can be chained together.
 */
export function makeIdentity(quat) {
 quat[0] = 0;
 quat[1] = 0;
 quat[2] = 0;
 quat[3] = 1;
 ...
 * @param {!AnyType} axis Unit vector specifying the
 *     axis of rotation.
 * @param {!AnyType} quat Unit quaternion to store the
 *     result.
 * @return {!AnyType} Return quat so that
 *     operations can be chained together.
 */
export function fromAngleAxis(angle, axis, quat) {
...
export function toAngleAxis(quat, axis) {
 ...
 if (magnitude < googVec.EPSILON) {
   ...
   Vec3.setFromValues(axis, quat[0], quat[1], quat[2]);
 ...
 *
 * @param {!googVec.AnyType} matrix The source matrix.
 * @param {!AnyType} quat The resulting quaternion.
 * @return {!AnyType} Return quat so that
 *     operations can be chained together.
 */
export function fromRotationMatrix3(matrix, quat) {
 ...
 *     operations can be chained together.
 */
export function fromRotationMatrix4(matrix, quat) {
 ...
 *
 * @param {!AnyType} quat The source quaternion.
 * @param {!googVec.AnyType} matrix The resulting matrix.
 * @return {!googVec.AnyType} Return resulting matrix so that
 *     operations can be chained together.
 */
export function toRotationMatrix3(quat, matrix) {
 const w = quat[3];
 const x = quat[0];
 const y = quat[1];
 const z = quat[2];
 ...
 *     operations can be chained together.
 */
export function toRotationMatrix4(quat, matrix) {
 const w = quat[3];
 const x = quat[0];
 const y = quat[1];
 const z = quat[2];
 ...
 *     operations can be chained together.
 */
export function rotateX(quat, angle, resultQuat) {
 angle *= 0.5;
 const aw = quat[3];
 const ax = quat[0];
 const ay = quat[1];
 ...
 *     operations can be chained together.
 */
export function rotateY(quat, angle, resultQuat) {
 angle *= 0.5;
 const aw = quat[3];
 const ax = quat[0];
 const ay = quat[1];
 ...
 *     operations can be chained together.
 */
export function rotateZ(quat, angle, resultQuat) {
 angle *= 0.5;
 const aw = quat[3];
 const ax = quat[0];
 const ay = quat[1];
 ...
 *
 * @param {!googVec.AnyType} vec The vec to transform.
 * @param {!AnyType} quat The quaternion.
 * @param {!googVec.AnyType} resultVec The vec to receive the result.
 * @return {!googVec.AnyType} Return resultVec so that operations can be
 *     chained together. Note that the caller is responsible for type-casting.
 */
export function transformVec(vec, quat, resultVec) {
 const x = vec[0];
 const y = vec[1];
 const z = vec[2];
 ...
 *     operations can be chained together.
 */
export function slerp(q0, q1, t, resultQuat) {
 ...
 let cosVal = dot_(q0, q1);
 if (cosVal > 1 || cosVal < -1) {
   Vec4.setFromArray(resultQuat, q1);
   return resultQuat;
 }
