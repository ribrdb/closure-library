...
/** @typedef {!googVec.ArrayType} */ export var Mat3Like;
...
export function createNumber() {
 const a = new Array(9);
 setFromValues(a, 0, 0, 0, 0, 0, 0, 0, 0, 0);
 return a;
}
 ...
 *
 * @return {!Float32} The new 9 element array.
 */
 ...
 *
 * @return {!Float64} The new 9 element array.
 */
 ...
 * The returned matrix is cleared to all zeros.
 *
 * @return {!Number} The new 9 element array.
 */
export function createNumberIdentity() {
 const a = new Array(9);
 setFromValues(a, 1, 0, 0, 0, 1, 0, 0, 0, 1);
 return a;
}
 ...
 * @return {!Type} The new 9 element array.
 */
 ...
 * @return {!Float32} The new, nine element array.
 */
 ...
 * @return {!Float32} The new, nine element array.
 */
export function createFloat32FromValues(v00, v10, v20, v01, v11, v21, v02, v12, v22) {
 const newMatrix = createFloat32();
 setFromValues(
 ...
 *
 * @param {Float32} matrix The source 3x3 matrix.
 * @return {!Float32} The new 3x3 element matrix.
 */
 ...
 * @return {!Float64} The new, nine element array.
 */
export function createFloat64FromValues(v00, v10, v20, v01, v11, v21, v02, v12, v22) {
 const newMatrix = createFloat64();
 setFromValues(
     newMatrix, v00, v10, v20, v01, v11, v21, v02, v12, v22);
 return newMatrix;
 ...
 *
 * @param {Float64} matrix The source 3x3 matrix.
 * @return {!Float64} The new 3x3 element matrix.
 */
 ...
 * @param {Mat3Like} matrix The array containing the
 *     matrix values in column major order.
 ...
 * @return {!Type} The new, nine element array.
 */
export function createFromValues(v00, v10, v20, v01, v11, v21, v02, v12, v22) {
 const newMatrix = create();
 setFromValues(
     newMatrix, v00, v10, v20, v01, v11, v21, v02, v12, v22);
 return newMatrix;
}
 ...
 * @param {Mat3Like} matrix The source 3x3 matrix.
 * @return {!Type} The new 3x3 element matrix.
 */
 ...
 *
 * @param {AnyType} mat The matrix containing the value to
 *     retrieve.
 ...
 *
 * @param {AnyType} mat The matrix to receive the values.
 * @param {AnyType} values The row major ordered array
 ...
 *
 * @param {AnyType} mat0 The matrix to invert.
 * @param {AnyType} resultMat The matrix to receive
...
export function makeTranslate(mat, x, y) {
 makeIdentity(mat);
 return setColumnValues(mat, 2, x, y, 1);
}
 ...
 *
 * @param {AnyType} mat The 3x3 (9-element) matrix
...
export function makeScale(mat, x, y, z) {
 makeIdentity(mat);
 return setDiagonalValues(mat, x, y, z);
}
...
export function makeRotateX(mat, angle) {
 const c = Math.cos(angle);
 const s = Math.sin(angle);
 return setFromValues(mat, 1, 0, 0, 0, c, s, 0, -s, c);
}
...
export function makeRotateY(mat, angle) {
 const c = Math.cos(angle);
 const s = Math.sin(angle);
 return setFromValues(mat, c, 0, -s, 0, 1, 0, s, 0, c);
}
...
export function makeRotateZ(mat, angle) {
 const c = Math.cos(angle);
 const s = Math.sin(angle);
 return setFromValues(mat, c, s, 0, -s, c, 0, 0, 0, 1);
}
