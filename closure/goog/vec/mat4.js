...
/** @typedef {!googVec.ArrayType} */ export var Mat4Like;
 ...
 *
 * @return {!Float32} The new 16 element array.
 */
export function createFloat32Identity() {
  const mat = createFloat32();
 ...
 *
 * @return {!Float64} The new 16 element array.
 */
export function createFloat64Identity() {
  const mat = createFloat64();
  mat[0] = mat[5] = mat[10] = mat[15] = 1;
  return mat;
}
 ...
 * The returned matrix is cleared to all zeros.
 *
 * @return {!Number} The new 16 element array.
 */
export function createNumberIdentity() {
  const a = new Array(16);
  setFromValues(
 ...
 * @return {!Type} The new 16 element array.
 */
export function createIdentity() {
  return createFloat32Identity();
}
 ...
 *
 * @param {AnyType} matrix The array containing the
 *     matrix values in column major order.
 * @return {!Float32} The new, 16 element array.
 */
export function createFloat32FromArray(matrix) {
  const newMatrix = createFloat32();
  setFromArray(newMatrix, matrix);
  return newMatrix;
}
 ...
 * @return {!Float32} The new, 16 element array.
 */
export function createFloat32FromValues(
  v00,
  v10,
  v20,
  v30,
 ...
 *
 * @param {Float32} matrix The source 4x4 matrix.
 * @return {!Float32} The new 4x4 element matrix.
 */
 ...
 * @param {AnyType} matrix The array containing the
 *     matrix values in column major order.
 * @return {!Float64} The new, nine element array.
 */
export function createFloat64FromArray(matrix) {
  const newMatrix = createFloat64();
  setFromArray(newMatrix, matrix);
  return newMatrix;
}
 ...
 * @return {!Float64} The new, 16 element array.
 */
export function createFloat64FromValues(
  v00,
  v10,
  v20,
  v30,
 ...
 *
 * @param {Float64} matrix The source 4x4 matrix.
 * @return {!Float64} The new 4x4 element matrix.
 */
 ...
 * @param {Mat4Like} matrix The array containing the
 *     matrix values in column major order.
 * @return {!Type} The new, nine element array.
 */
export function createFromArray(matrix) {
  const newMatrix = createFloat32();
  setFromArray(newMatrix, matrix);
  return newMatrix;
}
...
export function createFromValues(
  ...
  return createFloat32FromValues(
 ...
 * @param {Mat4Like} matrix The source 4x4 matrix.
 * @return {!Type} The new 4x4 element matrix.
 */
 ...
 *
 * @param {AnyType} mat The matrix containing the
 *     value to retrieve.
 ...
 *
 * @param {AnyType} mat The matrix to set the value on.
 * @param {number} row The row index.
 * @param {number} column The column index.
 ...
 *
 * @param {AnyType} mat The matrix to receive the
 *     values.
 * @param {number} v00 The values at (0, 0).
 * @param {number} v10 The values at (1, 0).
 * @param {number} v20 The values at (2, 0).
 ...
 * @param {AnyType} values The column major ordered
 *     array of values to store in the matrix.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
export function setFromArray(mat, values) {
  mat[0] = values[0];
  mat[1] = values[1];
  mat[2] = values[2];
  mat[3] = values[3];
 ...
 *
 * @param {AnyType} mat The matrix to receive the values.
 * @param {AnyType} values The row major ordered array of
 *     values to store in the matrix.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
export function setFromRowMajorArray(mat, values) {
  mat[0] = values[0];
  mat[1] = values[4];
  mat[2] = values[8];
  mat[3] = values[12];
 ...
 *     chained together.
 */
export function setDiagonalValues(mat, v00, v11, v22, v33) {
  mat[0] = v00;
  mat[5] = v11;
  mat[10] = v22;
  mat[15] = v33;
 ...
 *
 * @param {AnyType} mat The matrix to receive the values.
 * @param {Vec4.AnyType} vec The vector containing the values.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {AnyType} mat The matrix containing the values.
 * @param {Vec4.AnyType} vec The vector to receive the values.
 ...
 * @return {Vec4.AnyType} return vec so that operations can be
 *     chained together.
 */
export function getDiagonal(mat, vec, opt_diagonal) {
  if (!opt_diagonal) {
 ...
 *     chained together.
 */
export function setColumnValues(mat, column, v0, v1, v2, v3) {
  const i = column * 4;
  mat[i] = v0;
  mat[i + 1] = v1;
  mat[i + 2] = v2;
 ...
 * @param {AnyType} mat The matrix to receive the values.
 * @param {number} column The column index to set the values on.
 * @param {Vec4.AnyType} vec The vector of elements for the column.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
 ...
 * @param {Vec4.AnyType} vec The vector of elements to
 *     receive the column.
 * @return {Vec4.AnyType} return vec so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {AnyType} mat The matrix to receive the values.
 * @param {Vec4.AnyType} vec0 The values for column 0.
 * @param {Vec4.AnyType} vec1 The values for column 1.
 * @param {Vec4.AnyType} vec2 The values for column 2.
 * @param {Vec4.AnyType} vec3 The values for column 3.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
export function setColumns(mat, vec0, vec1, vec2, vec3) {
  setColumn(mat, 0, vec0);
  setColumn(mat, 1, vec1);
  setColumn(mat, 2, vec2);
  setColumn(mat, 3, vec3);
  return mat;
}
 ...
 * @param {Vec4.AnyType} vec0 The vector to receive column 0.
 * @param {Vec4.AnyType} vec1 The vector to receive column 1.
 * @param {Vec4.AnyType} vec2 The vector to receive column 2.
 * @param {Vec4.AnyType} vec3 The vector to receive column 3.
 */
export function getColumns(mat, vec0, vec1, vec2, vec3) {
  getColumn(mat, 0, vec0);
  getColumn(mat, 1, vec1);
  getColumn(mat, 2, vec2);
  getColumn(mat, 3, vec3);
}
 ...
 *     chained together.
 */
export function setRowValues(mat, row, v0, v1, v2, v3) {
  mat[row] = v0;
  mat[row + 4] = v1;
  mat[row + 8] = v2;
  mat[row + 12] = v3;
 ...
 * @param {Vec4.AnyType} vec The vector to receive the row.
 * @return {Vec4.AnyType} return vec so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {AnyType} mat The matrix to receive the values.
 * @param {Vec4.AnyType} vec0 The values for row 0.
 * @param {Vec4.AnyType} vec1 The values for row 1.
 * @param {Vec4.AnyType} vec2 The values for row 2.
 * @param {Vec4.AnyType} vec3 The values for row 3.
 * @return {AnyType} return mat so that operations can be
 *     chained together.
 */
export function setRows(mat, vec0, vec1, vec2, vec3) {
  setRow(mat, 0, vec0);
  setRow(mat, 1, vec1);
  setRow(mat, 2, vec2);
  setRow(mat, 3, vec3);
 ...
 *
 * @param {AnyType} mat The matrix to supply the values.
 * @param {Vec4.AnyType} vec0 The vector to receive row 0.
 * @param {Vec4.AnyType} vec1 The vector to receive row 1.
 * @param {Vec4.AnyType} vec2 The vector to receive row 2.
 * @param {Vec4.AnyType} vec3 The vector to receive row 3.
 */
export function getRows(mat, vec0, vec1, vec2, vec3) {
  getRow(mat, 0, vec0);
  getRow(mat, 1, vec1);
  getRow(mat, 2, vec2);
  getRow(mat, 3, vec3);
 ...
 * @return {!AnyType} return mat so operations can be chained.
 */
 ...
 *
 * @param {AnyType} mat0 The first addend.
 * @param {AnyType} mat1 The second addend.
 * @param {AnyType} resultMat The matrix to
 *     receive the results (may be either mat0 or mat1).
 * @return {AnyType} return resultMat so that operations can be
 *     chained together.
 */
 ...
 *
 * @param {AnyType} mat0 The minuend.
 * @param {AnyType} mat1 The subtrahend.
 * @param {AnyType} resultMat The matrix to receive
 ...
 * storing the result into resultMat.
 *
 * @param {AnyType} mat0 The first (left hand) matrix.
 * @param {AnyType} mat1 The second (right hand) matrix.
 * @param {AnyType} resultMat The matrix to receive
 *     the results (may be either mat0 or mat1).
 * @return {AnyType} return resultMat so that operations can be
 *     chained together.
 ...
 *
 * @param {AnyType} mat The matrix to transpose.
 * @param {AnyType} resultMat The matrix to receive
 *     the results (may be mat).
 * @return {AnyType} return resultMat so that operations can be
 *     chained together.
 ...
 *
 * @param {AnyType} mat The matrix to compute the matrix for.
 ...
 *
 * @param {AnyType} mat0 The first matrix.
 * @param {AnyType} mat1 The second matrix.
 ...
 * @param {Vec3.AnyType} vec The 3 element vector to transform.
 * @param {Vec3.AnyType} resultVec The 3 element vector to
 ...
 *     chained together.
 */
export function multVec3NoTranslate(mat, vec, resultVec) {
  const x = vec[0];
  const y = vec[1];
  const z = vec[2];
 ...
 * @param {AnyType} mat The matrix supplying the transformation.
 * @param {Vec3.AnyType} vec The 3 element vector to transform.
 * @param {Vec3.AnyType} resultVec The 3 element vector
 *     to receive the results (may be vec).
 * @return {Vec3.AnyType} return resultVec so that operations can be
 *     chained together.
 */
export function multVec3Projective(mat, vec, resultVec) {
  const x = vec[0];
  const y = vec[1];
  const z = vec[2];
 ...
 *
 * @param {AnyType} mat The matrix supplying the transformation.
 * @param {Vec4.AnyType} vec The vector to transform.
 * @param {Vec4.AnyType} resultVec The vector to
 *     receive the results (may be vec).
 * @return {Vec4.AnyType} return resultVec so that operations can be
 *     chained together.
 */
export function multVec4(mat, vec, resultVec) {
  const w = vec[3];
  const x = vec[0];
  const y = vec[1];
  const z = vec[2];
 ...
 *     chained.
 */
export function makeTranslate(mat, x, y, z) {
  makeIdentity(mat);
  return setColumnValues(mat, 3, x, y, z, 1);
}
...
export function makeScale(mat, x, y, z) {
  makeIdentity(mat);
  return setDiagonalValues(mat, x, y, z, 1);
}
 ...
 *     chained.
 */
export function makeFrustum(mat, left, right, bottom, top, near, far) {
 ...
 *     chained.
 */
export function makePerspective(mat, fovy, aspect, near, far) {
  const angle = fovy / 2;
  const dz = far - near;
 ...
 *     chained.
 */
export function makeOrtho(mat, left, right, bottom, top, near, far) {
 ...
 *
 * @param {AnyType} mat The matrix.
 * @param {Vec3.AnyType} eyePt The position of the eye point
 *     (camera origin).
 * @param {Vec3.AnyType} centerPt The point to aim the camera at.
 * @param {Vec3.AnyType} worldUpVec The vector that identifies
 *     the up direction for the camera.
 * @return {AnyType} return mat so that operations can be
 *     chained.
 */
export function makeLookAt(mat, eyePt, centerPt, worldUpVec) {
  // Compute the direction vector from the eye point to the center point and
  // normalize.
  const fwdVec = tmpVec4_[0];
  Vec3.subtract(centerPt, eyePt, fwdVec);
  Vec3.normalize(fwdVec, fwdVec);
  fwdVec[3] = 0;

  // Compute the side vector from the forward vector and the input up vector.
  const sideVec = tmpVec4_[1];
  Vec3.cross(fwdVec, worldUpVec, sideVec);
  Vec3.normalize(sideVec, sideVec);
  sideVec[3] = 0;

  // Now the up vector to form the orthonormal basis.
  const upVec = tmpVec4_[2];
  ...
  setRow(mat, 0, sideVec);
  setRow(mat, 1, upVec);
  setRow(mat, 2, fwdVec);
  setRowValues(mat, 3, 0, 0, 0, 1);
  translate(mat, -eyePt[0], -eyePt[1], -eyePt[2]);
 ...
 * @param {Vec3.AnyType} eyePt The position of the eye point
 *     (camera origin).
 * @param {Vec3.AnyType} fwdVec The vector describing where
 *     the camera points to.
 * @param {Vec3.AnyType} worldUpVec The vector that
 ...
 */
export function toLookAt(mat, eyePt, fwdVec, worldUpVec) {
  // Get eye of the camera.
  const matInverse = tmpMat4_[0];
  if (!invert(mat, matInverse)) {
  ...
  if (worldUpVec) {
    ...
    const side = tmpVec3_[1];
    side[0] = mat[0];
    side[1] = mat[4];
    side[2] = mat[8];
    // Compute up vector as a up = side x forward.
    Vec3.cross(side, fwdVec, worldUpVec);
    // Normalize up vector.
    Vec3.normalize(worldUpVec, worldUpVec);
  }
  return true;
}
 ...
 *     of the default [0, pi].
 * @return {Vec4.AnyType} return euler so that operations can be
 *     chained together.
 */
 ...
 *     chained.
 */
export function translate(mat, x, y, z) {
  return setColumnValues(
 ...
 *     chained.
 */
export function scale(mat, x, y, z) {
  return setFromValues(
 ...
 *
 * @param {AnyType} mat The transformation matrix.
 * @param {Vec3.AnyType} translation The vector for storing the
 *     result.
 * @return {AnyType} return mat so that operations can be
 *     chained.
 */
export function getTranslation(mat, translation) {
 ...
 * @private
 */
var tmpVec3_ = [Vec3.createFloat64(), Vec3.createFloat64()];
 ...
 */
var tmpVec4_ = [
  Vec4.createFloat64(), Vec4.createFloat64(),
  Vec4.createFloat64()
];
