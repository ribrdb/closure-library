...
goog.declareModuleId('goog.events.listener');
 ...
 * @constructor
 */
export function Listener(listener, proxy, src, type, capture, opt_handler) {
 if (Listener.ENABLE_MONITORING) {
 ...
 * @type {string}
 */
Listener.prototype.creationStack;
