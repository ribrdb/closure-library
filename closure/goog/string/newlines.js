 ...
 * @final
 */
export function Line(string, startLineIndex, endContentIndex, endLineIndex) {
 /**
  * The original string.
  * @type {string}
  */
 ...
 */
Line.prototype.getFullLine = function() {
 ...
 */
Line.prototype.getNewline = function() {
 ...
 * @param {string} str String to split.
 * @return {!Array<!Line>} Array of line metadata.
 */
export function getLines(str) {
 ...
 if (sliceIndex < str.length) {
   const line =
       new Line(str, sliceIndex, str.length, str.length);
   lines.push(line);
 }
