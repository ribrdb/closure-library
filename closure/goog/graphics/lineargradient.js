 ...
 * @final
 */
export function LinearGradient(x1, y1, x2, y2, color1, color2, opt_opacity1, opt_opacity2) {
 /**
...
goog.inherits(LinearGradient, Fill);


/**
 * @return {number} The start X position of the gradient.
 */
LinearGradient.prototype.getX1 = function() {
 return this.x1_;
};
 ...
 */
LinearGradient.prototype.getY1 = function() {
 return this.y1_;
};
 ...
 */
LinearGradient.prototype.getX2 = function() {
 return this.x2_;
};
 ...
 */
LinearGradient.prototype.getY2 = function() {
 return this.y2_;
};
 ...
 * @override
 */
LinearGradient.prototype.getColor1 = function() {
 return this.color1_;
};
 ...
 * @override
 */
LinearGradient.prototype.getColor2 = function() {
 return this.color2_;
};
 ...
 */
LinearGradient.prototype.getOpacity1 = function() {
 ...
 */
LinearGradient.prototype.getOpacity2 = function() {
