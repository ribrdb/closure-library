...
goog.declareModuleId('goog.graphics.path');
 ...
 * @private
 */
Path.prototype.closePoint_ = null;
 ...
 * @private
 */
Path.prototype.currentPoint_ = null;
 ...
 * @return {!Path} The path itself.
 */
Path.prototype.arcToAsCurves = function(
 ...
 * @type {!Object}
 * @private
 * @suppress {deprecated} Path is deprecated.
 */
Path.simplifySegmentMap_ = (function() {
  ...
  map[Path.Segment.CURVETO] =
      Path.prototype.curveTo;
  map[Path.Segment.ARCTO] =
      Path.prototype.arcToAsCurves;
  return map;
})();
