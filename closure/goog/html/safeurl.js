 ...
 * @const
 */
SafeUrl.prototype.implementsGoogStringTypedString = true;
...
SafeUrl.fromBlob = function(blob) {
  var url = SafeUrl.isSafeMimeType(blob.type) ?
 ...
 */
SafeUrl.revokeObjectUrl = function(safeUrl) {
  var url = safeUrl.getTypedStringValue();
  if (url !== SafeUrl.INNOCUOUS_STRING) {
...
SafeUrl.fromDataUrl = function(dataUrl) {
  return SafeUrl.tryFromDataUrl(dataUrl) ||
      SafeUrl.INNOCUOUS_URL;
};
 ...
 */
SafeUrl.fromTelUrl = function(telUrl) {
 ...
 *     wrapped as a SafeUrl if it does not pass.
 */
SafeUrl.fromFacebookMessengerUrl = function(facebookMessengerUrl) {
 ...
 *     wrapped as a SafeUrl if it does not pass.
 */
SafeUrl.fromWhatsAppUrl = function(whatsAppUrl) {
  if (!internal.caseInsensitiveStartsWith(
 ...
 *     wrapped as a SafeUrl if it does not pass.
 */
SafeUrl.fromSmsUrl = function(smsUrl) {
 ...
 * @private
 */
SafeUrl.isSmsUrlBodyValid_ = function(smsUrl) {
 ...
 *     wrapped as a SafeUrl if it does not pass.
 */
SafeUrl.fromSshUrl = function(sshUrl) {
 ...
 */
SafeUrl.sanitizeChromeExtensionUrl = function(url, extensionId) {
 ...
 *     `INNOCUOUS_STRING` if it's not.
 */
SafeUrl.sanitizeFirefoxExtensionUrl = function(url, extensionId) {
  return SafeUrl.sanitizeExtensionUrl_(
 ...
 *     `INNOCUOUS_STRING` if it's not.
 */
SafeUrl.sanitizeEdgeExtensionUrl = function(url, extensionId) {
  return SafeUrl.sanitizeExtensionUrl_(
 ...
 *     `INNOCUOUS_STRING` if it's not.
 */
SafeUrl.sanitizeExtensionUrl_ = function(scheme, url, extensionId) {
 ...
 * @package
 */
SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse = function(
    url) {
  return new SafeUrl(
      url, SafeUrl.CONSTRUCTOR_TOKEN_PRIVATE_);
};
