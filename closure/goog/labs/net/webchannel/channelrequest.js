...
goog.declareModuleId('goog.labs.net.webchannel.channelrequest');
...
import * as webChannelEnvironment from './environment.js';
import * as webChannelRequestStats from './requeststats.js';
 ...
 *
 * @param {webChannelChannel} channel
 *     The channel that owns this request.
 * @param {webChannelWebChannelDebug} channelDebug A
...
export function ChannelRequest(channel, channelDebug, opt_sessionId, opt_requestId, opt_retryId) {
  /**
     ...
     * @private {webChannelChannel}
     */
  this.channel_ = channel;

  /**
     * The channel debug to use for logging
     * @private {webChannelWebChannelDebug}
     */
   ...
   * @private {number}
   */
  this.timeout_ = ChannelRequest.TIMEOUT_MS_;
  ...
  /**
     ...
     */
  this.pollingTimer_ =
      new Timer(webChannelEnvironment.getPollingInterval());
...
goog.scope(function() {
  ...
  ChannelRequest.prototype.decodeXmlHttpResponse_ = function() {
    ...
    const requestCompleted =
        this.xmlHttp_.getReadyState() == XmlHttp.ReadyState.COMPLETE;
